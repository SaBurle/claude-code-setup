...
📖 [Manual de Comandos](MANUAL-COMANDOS.md) ([versão HTML navegável](manual.html), também publicada em [saburle.github.io/claude-code-setup/manual.html](https://saburle.github.io/claude-code-setup/manual.html)) — guia de referência para quem está começando com terminal/PowerShell e Claude Code.
